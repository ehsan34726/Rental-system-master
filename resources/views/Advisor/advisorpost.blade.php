				...
				<div class="col-lg-4 col-md-6">
					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							<a href="#" class="room-price">BDT {{$postdata->rent}}</a>
						</div>
					</div>
				</div>
    ...
    <div class="modal-content card card-image" style="background-image: url('img/modelimg.jpg');">
      <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
        ...
        <div class="modal-body">
          ...
          <div class="md-form pb-3">
            <input type="text" name="rent" value="{{Session('update_post')->rent}}" autocomplete="off" placeholder="e.g 15,000 BDT" id="Form-pass5" class="form-control validate white-text">
            <label data-error="wrong" data-success="right" for="Form-pass5">Monthly Rent</label>
          </div>
          <div class="md-form pb-3">
            <input type="text" name="city" value="{{Session('update_post')->city}}" autocomplete="off" placeholder="e.g Gulshan" id="Form-pass5" class="form-control validate white-text">
        ...
        <div class="md-form pb-3">
            <select name="state" style="border-radius: 5px;border: none;padding: 10px 271px 10px 0;">
             @if(Session('update_post')->state =="DHAKA")
              <option value="DHAKA" selected>DHAKA</option>
              <option value="SYLHET">SYLHET</option>
              <option value="CHOTTOGRAM">CHOTTOGRAM</option>
              <option value="BARISHAL">BARISHAL</option>
              @elseif(Session('update_post')->state =="SYLHET")
              <option value="SYLHET" selected>SYLHET</option>
              <option value="DHAKA">DHAKA</option>
              <option value="CHOTTOGRAM">CHOTTOGRAM</option>
              <option value="BARISHAL">BARISHAL</option>
              @elseif(Session('update_post')->state =="CHOTTOGRAM")
              <option value="CHOTTOGRAM" selected>CHOTTOGRAM</option>
              <option value="DHAKA">DHAKA</option>
              <option value="SYLHET">SYLHET</option>
              <option value="BARISHAL">BARISHAL</option>
              @elseif(Session('update_post')->state =="BARISHAL")
              <option value="BARISHAL" selected>BARISHAL</option>
              <option value="DHAKA">DHAKA</option>
              <option value="SYLHET">SYLHET</option>
              <option value="CHOTTOGRAM">CHOTTOGRAM</option>
              @endif
          ...
          <div class="md-form pb-3">
            <input type="text" name="address" value="{{Session('update_post')->address}}" autocomplete="off" placeholder="e.g DHAKA" id="Form-pass5" class="form-control validate white-text">
