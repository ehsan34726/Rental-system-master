					...
					<div class="single-list-content">
						<div class="row">
							<div class="col-xl-8 sl-title">
								<h2>305 GULSHAN</h2>
								<p><i class="fa fa-map-marker"></i>USA HIGH COMISSION AVE, H/N210</p>
							</div>
							<div class="col-xl-4">
								<a href="#" class="price-btn">$4,500</a>
							</div>
						</div>
						<h3 class="sl-sp-title">Property Details</h3>
						<div class="row property-details-list">
							<div class="col-md-4 col-sm-6">
								<p><i class="fa fa-th-large"></i> 1500 Square feet</p>
							...
							<div class="col-md-4">
								...
								<p><i class="fa fa-user"></i> Ms. Marzina</p>
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-7 sidebar">
					<div class="author-card">
						...
						<div class="author-contact">
							<p><i class="fa fa-phone"></i>0158985865</p>
							<p><i class="fa fa-envelope"></i>marzina26@gmail.com</p>
						</div>
					</div>
					</div>
				</div>
